...
const Cards = () => {
  ...
  return (
    <div className="mt-10">
        <div className="divider divider-neutral text-xl md:text-2xl lg:text-3xl font-bold mb-12">Our Services</div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {edus?.map(edu => <div key={edu.id} className="flex max-w-md overflow-hidden bg-white rounded-lg shadow-lg">
        <div className="w-1/3 bg-cover bg-landscape"><img src={edu.imageUrl} alt=""/></div>
