...
import viedo from "../assets/image/viedo.mp4";
const Extraroute = () => {
  return (
    <div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            ...
            <video
              ...
              width="2432"
              height="1442"
              // controls // Add this to make the video playable
            />
            {/* <img src={viedo} alt="Product screenshot" className="w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0" width="2432" height="1442"/> */}
          </div>
        </div>
      </section>
    </div>
